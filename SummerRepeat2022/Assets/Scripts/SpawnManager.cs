...
public static void spawnPosition()
{
 ...
 /* Transform GetSpawnPoint()
    ...
    void Start()
    {
        ...
        */
        Instantiate(keyPrefab[0], spawnPoints[Random.Range(0, 4)], Quaternion.identity);
        Instantiate(keyPrefab[1], spawnPoints[Random.Range(0, 4)], Quaternion.identity);
        
         if(keyPrefab[1].transform.position == keyPrefab[0].transform.position)
        {
           Destroy(keyPrefab[1]);
           Instantiate(keyPrefab[1], spawnPoints[Random.Range(0, 4)], Quaternion.identity);
        }
