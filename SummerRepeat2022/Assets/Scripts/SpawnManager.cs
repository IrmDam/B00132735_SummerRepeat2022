...
public static void spawnPosition()
{
    ...
    Vector3 spawnPos2 = new Vector3(13.9f, -3f, .34f);
...
*/
    ...
    void Start()
    {
        ...
        */
        Instantiate(keyPrefab[0], spawnPoints[2], Quaternion.identity);
        //Instantiate(keyPrefab[1], _randomPosition1, Quaternion.identity);
    }
